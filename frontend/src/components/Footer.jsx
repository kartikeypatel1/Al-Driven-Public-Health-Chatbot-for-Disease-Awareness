        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              AI-powered healthcare assistant providing multilingual support, ASHA integration, and outbreak alerts for
              rural communities.
            </p>
            <div className="flex items-center space-x-2 text-sm text-gray-400">
              ...
              <span>Supported by Government of India</span>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-6 mb-4 md:mb-0">
              <p className="text-gray-400 text-sm">© 2024 HealthBot. All rights reserved.</p>
              <div className="flex items-center space-x-2 text-sm text-gray-400">
                <span>Emergency:</span>
                <a href="tel:108" className="text-health-400 hover:text-health-300 font-semibold">
                  108
                </a>
              </div>
            </div>
